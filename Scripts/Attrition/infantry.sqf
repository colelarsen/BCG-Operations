...
_spawnInfantry = {
    if (isDedicated || IS_DEVELOPING) then {
        ...
        h = [[_spawn1,_spawn2,_spawn3],_Spawngroups,_AISkills,_Spawnside,_enemySide,_Spawnmindelay,_Spawnavgdelay,_Spawnmaxdelay,_SpawnAvgDegrade, "attack-players"] spawn spawnWaves;
